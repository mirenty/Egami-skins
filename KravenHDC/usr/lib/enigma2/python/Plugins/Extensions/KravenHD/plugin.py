...
config.plugins.KravenHD.InfobarSystemInfo = ConfigSelection(default="infobar-systeminfo-none", choices = [
				("infobar-systeminfo-on", _("On")),
				("infobar-systeminfo-none", _("Off"))
				])
			
config.plugins.KravenHD.InfobarClockWidget = ConfigSelection(default="infobar-clock-none", choices = [
				("infobar-clock-none", _("Off for ZZ1")),
...
<screen name="KravenHD-Setup" position="0,0" size="1280,720" flags="wfNoBorder" backgroundColor="transparent">
  ...
  <eLabel position="738,20" size="349,43" text="Version: 4.9.0" foregroundColor="foreground" font="Regular; 35" valign="center" backgroundColor="KravenPreBlack2" transparent="1" halign="center" />
...
<eLabel position="280,20" size="349,43" text="Setup" foregroundColor="foreground" font="Regular; 35" valign="center" backgroundColor="KravenPreBlack2" transparent="1" halign="left" /></screen>
"""
